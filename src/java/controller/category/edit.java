...
public class edit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            cat.setName(name);
            DAOCategory.update(cat);
            response.sendRedirect(request.getContextPath() + "/admin/category.jsp?success=1");
        } catch(SQLException e) {
            response.sendRedirect(request.getContextPath() + "/admin/category/edit.jsp?id=" + id + "&error=1");
        }
    }
