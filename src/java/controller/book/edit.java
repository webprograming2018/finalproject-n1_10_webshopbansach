...
public class edit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int left_quantity = Integer.parseInt(request.getParameter("left_quantity"));
        ...
        try {
            ...
            response.sendRedirect(request.getContextPath() + "/admin/book.jsp?success=1");
        } catch (SQLException ex) {
            response.sendRedirect(request.getContextPath() + "/admin/book/edit.jsp?id=" + id + "&error=1");
        }
    }
